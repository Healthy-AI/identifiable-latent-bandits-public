"""Imported from https://github.com/yzhao062/pyod/blob/master/pyod/utils/torch_utility.py

Copying the code here for potential further use and to avoid the dependency on pyod package.
"""
