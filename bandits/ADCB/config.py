...
latent_dim = "continuous"
# alpha_values = [0, -13.84, -17.60, -21.51, -22.70, -14.26, -9.16, -19.09]
# gamma_values = [0] * 8  # Since gamma_i is 0 for all treatments
z_noise = 0.02
ATE_noise = 0.5


gamma_values = [0, -0.5, -1, -0.5, -2, -3.5, -1, -2.9]
alpha_values = [
    0.0,
    -10.284233498192426,
    -10.497010742982615,
...
gamma_dict = {
    0: [0, -0.5, -1, -0.5, -2, -3.5, -1, -2.90],  # Gamma values for gene/APOE4 = 0
    1: [0, -1.0, -1.5, -2.0, -2.5, -0.1, -1.5, -4.0],  # Gamma values for gene/APOE4 = 1
    2: [
        0,
        -3.5,
        -0.75,
...
DX_Codes = {"CN": int(0), "MCI": int(1), "Dementia": int(2)}
...
PTETHCAT_Codes = {"Hisp/Latino": 0, "Not Hisp/Latino": 1, "Unknown": 2}
...
A_Delta = {0: 0, 1: -1.95, 2: -2.48, 3: -3.03, 4: -3.20, 5: -2.01, 6: -1.29, 7: -2.69}
...
imputation_cols = ["TAU", "PTAU", "FDG", "AV45", "ADAS13", "MMSE", "CDRSB", "DX"]
...
clf_parameters_all = {
    "lr": [{"solver": ["lbfgs", "newton-cg", "sag", "saga"]}],
    "rfc": [
        {
